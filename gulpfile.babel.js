...
gulp.task('fonts', () => {
  return gulp.src(require('main-bower-files')('**/*.{eot,svg,ttf,woff,woff2}', function (err) {})
    .concat(['app/fonts/**/*', 'node_modules/materialize-css/dist/fonts/**/*']))
...
gulp.task('serve', ['styles', 'scripts', 'fonts'], () => {
  ...
  gulp.watch('app/styles/**/*.scss', ['scripts']);
  gulp.watch('app/scripts/**/*.scss', ['scripts']);
  gulp.watch('app/scripts/**/*.css', ['styles']);
